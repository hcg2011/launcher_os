...
public abstract class RecentsView<T extends BaseActivity> extends PagedView implements Insettable {
    ...
    private void updateClearAllButtonAlpha() {
        if (mClearAllButton != null) {
			//prize add by huhuan,One key cleaning-often shown,20180926-start
            final float alpha = 1.0f;//calculateClearAllButtonAlpha();
			//prize add by huhuan,One key cleaning-often shown,20180926-end
            final boolean revealed = alpha == 1;
			mIsClearAllButtonFullyRevealed = false;
			/*
    ...
    public void showTask(int runningTaskId) {
        if (getChildCount() == 0) {
            ...
            mTmpRunningTask = new Task(new Task.TaskKey(runningTaskId, 0, new Intent(), null,0, 0), null,
