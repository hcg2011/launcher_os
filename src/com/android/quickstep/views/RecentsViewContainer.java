...
public class RecentsViewContainer extends InsettableFrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		//prize add by huhuan, change One_key_cleaning,20180926-start
	 ...
	 mClearAllButton.setTranslationX(
                mTempRect.left + (mTempRect.width() - mClearAllButton
                        .getMeasuredWidth()) / 2
                        - mClearAllButton.getLeft());
        mClearAllButton.setTranslationY(
                mTempRect.top + mTempRect.height() + mClearAllButton.getMeasuredHeight());
        //prize add by huhuan, change One_key_cleaning ,20180926-end
    }
