...
public class WidgetImageView extends View {
    ...
    private void updateDstRectF() {
        ...
        //prize modify by lishilun,fix 69623,Reduce scaling of widgetImageview,20181211-start
      //  final float scale = bitmapWidth > myWidth ? myWidth / bitmapWidth : 1;
        final float scale = bitmapWidth > myWidth ? myWidth / bitmapWidth : 0.9f;
        //prize modify by lishilun,fix 69623,Reduce scaling of widgetImageview,20181211-end
