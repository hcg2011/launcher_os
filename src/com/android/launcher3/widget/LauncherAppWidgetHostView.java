...
public class LauncherAppWidgetHostView extends AppWidgetHostView
    ...
    public  boolean isChrome() {
       LauncherAppWidgetInfo info = (LauncherAppWidgetInfo) this.getTag();
      String pkg = info.providerName.getPackageName();
     String cls = info.providerName.getClassName();
     if("com.android.chrome".equals(pkg)&& "org.chromium.chrome.browser.searchwidget.SearchWidgetProvider".equals(cls)) {
         return true;
     }
        return false;
    }
