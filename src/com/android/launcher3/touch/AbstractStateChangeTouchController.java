...
//add by zhouerlong prize launcher 20180906
        Log.i("zhouerlong","progress   "+progress);
//add by zhouerlong prize launcher 20180906
...
//add by zhouerlong 20180928
        if(!LauncherAppState.isDisableAllApps()) {
		 //prize add by huhuan,Solve bug 70538,20190108-start
		  if(mCurrentAnimation != null){
            mCurrentAnimation.setPlayFraction(fraction);
		   }
		 //prize add by huhuan,Solve bug 70538,20190108-end
        }
//add by zhouerlong 20180928
