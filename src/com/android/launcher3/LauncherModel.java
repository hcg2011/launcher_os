...
//add by zhouerlong prize launcher 20180906
    public void verifyApplications() {
        ...
        final ArrayList<ItemInfo> added = new ArrayList<ItemInfo>();
        synchronized (mLock) {
            for (AppInfo app : mBgAllAppsList.data) {
                ItemInfoMatcher  mathcers =ItemInfoMatcher.ofComponent(app.componentName,app.user);
                tmpInfos = mathcers.filterItemInfos(sBgDataModel.itemsIdMap);
                if (tmpInfos.isEmpty()) {
        ...
        if (!added.isEmpty()) {
            ...
            for (ItemInfo info:added) {
                Pair<ItemInfo ,Object> item = new Pair<ItemInfo, Object>(info,null);
