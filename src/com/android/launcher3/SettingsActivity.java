...
public class SettingsActivity extends Activity {
    ...
    private static final String SCREEN_STYLE = "screen_style";
	//prize add by zhouerlong screen____style
    ...
    //prize add by lishilun,fix 67605,Remove the menu add_icon_to_home,20181119-start
    public static final String ADD_HOME_PREFERENCE_KEY  = "pref_add_icon_to_home";
    //prize add by lishilun,fix 67605,Remove the menu add_icon_to_home,20181119-end
    @Override
	...
	//prize add by zhouerlong screen____style
            ButtonPreference screenstyle =
                    (ButtonPreference) findPreference(SCREEN_STYLE);
            screenstyle.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {

                    getActivity().startActivity(new Intent(getActivity(),ScreenStyleActivity.class));
                    return false;
                }
            });
//add by zhouerlong 20190116
            if(!Launcher.screen_style) {
                getPreferenceScreen().removePreference(screenstyle);
            }
//add by zhouerlong 20190116
	//prize add by zhouerlong screen____style
            ...
            //prize add by huhuan,Remove the menu icon_shape_override_label,20181008-start
            if(LauncherAppState.isDisableAllApps()){
                getPreferenceScreen().removePreference(iconShapeOverride);
            }
            //prize add by huhuan,Remove the menu icon_shape_override_label,20181008-end
            ...
            //prize add by huhuan,Remove the menu allow_rotation_title,20181008-start
...
//            }
            getPreferenceScreen().removePreference(rotationPref);
            //prize add by huhuan,Remove the menu allow_rotation_title,20181008-end

            //prize add by lishilun,fix 67605,Remove the menu add_icon_to_home,20181119-start
            if(LauncherAppState.isDisableAllApps()){
                getPreferenceScreen().removePreference(findPreference(ADD_HOME_PREFERENCE_KEY));
            }
            //prize add by lishilun,fix 67605,Remove the menu add_icon_to_home,20181119-end
        }
