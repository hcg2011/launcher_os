...
public class OptionsPopupView extends ArrowPopup
    ...
    public static void showDefaultOptions(Launcher launcher, float x, float y) {
		...
		//prize add by huhuan, change  longpress desktop icon, 20180929-start
        options.add(new OptionItem(R.string.wallpaper_button_text, R.drawable.ic_wallpaper_new,
                ControlType.WALLPAPER_BUTTON, OptionsPopupView::startWallpaperPicker));
        options.add(new OptionItem(R.string.widget_button_text, R.drawable.ic_widget_new,
                ControlType.WIDGETS_BUTTON, OptionsPopupView::onWidgetsClicked));
        options.add(new OptionItem(R.string.settings_button_text, R.drawable.ic_setting_new,
                ControlType.SETTINGS_BUTTON, OptionsPopupView::startSettings));
		//prize add by huhuan, change  longpress desktop icon, 20180929-start
//add by zhouerlong prize launcher 20180906
        if(LauncherAppState.isDisableAllApps()) {
            options.add(new OptionItem(R.string.theme_text, R.drawable.icon_theme,
                    ControlType.THEMES_BUTTON, OptionsPopupView::startThemes));
        }
//add by zhouerlong prize launcher 20180906
...
//add by zhouerlong prize launcher 20180906
    public static boolean startThemes(View view) {
        Launcher launcher = Launcher.getLauncher(view.getContext());
        Intent intent = new Intent(view.getContext(), ThemeActivity.class);
		//prize add by huhuan,BUG 68144,20181127-start
       // intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
	   //prize add by huhuan,BUG 68144,20181127-end
