...
public class PrizeRadioGroup extends LinearLayout {
    ...
    public PrizeRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public PrizeRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new PrizeRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof PrizeRadioGroup.LayoutParams;
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == PrizeRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == PrizeRadioGroup.this
