...
public class AutoInstallsLayout {
    ...
    private static final String ATTR_AllAPPS_WORKSPACE = "name";
	//add by zhouerlong 20180906 update all apps 
	...
	//add by zhouerlong 20180906 update all apps 
            int resId = getAttributeResourceValue(parser, LauncherAppState.isDisableAllApps() ? ATTR_WORKSPACE : ATTR_AllAPPS_WORKSPACE, 0);
            if(resId ==0) {
                resId = getAttributeResourceValue(parser, ATTR_WORKSPACE, 0);
