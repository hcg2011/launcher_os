...
//add by zhouerlong prize launcher 20180906
            ...
            mIcon.mPreviewLayoutRule.init(mIcon.getFolderBackground().previewSize, mIntrinsicIconSize,
...
//add by zhouerlong prize launcher 20180906
            if (LauncherAppState.isDisableAllApps()) {
                if (params.size() < ClippedFolderIconLayoutRule.MAX_NUM_ITEMS_IN_PREVIEW) {
