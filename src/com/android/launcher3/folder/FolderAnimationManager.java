...
public class FolderAnimationManager {
    ...
    public AnimatorSet getAnimator() {
		...
		//add by zhouerlong prize launcher 20190109
        float initialScale = previewSize / (itemsInPreview.size()<1?previewSize:itemsInPreview.get(0).getIconSize())
...
//add by zhouerlong prize launcher 20180906
        if(LauncherAppState.isDisableAllApps()) {
            play(a, getAnimator(mFolder, View.ALPHA, initAlpha, finalAlpha));
        }
//add by zhouerlong prize launcher 20180906
