...
//add by zhouerlong prize launcher 20180906
    private static final float MIN_SCALE = LauncherAppState.isDisableAllApps()?0.32f:0.48f;
    private static final float MAX_SCALE = LauncherAppState.isDisableAllApps()?0.32f:0.58f;
    private static final float MAX_RADIUS_DILATION = 0.15f;
    private static final float ITEM_RADIUS_SCALE_FACTOR = LauncherAppState.isDisableAllApps()?1.1f:1.33f;
//add by zhouerlong prize launcher 20180906
