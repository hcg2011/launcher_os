...
//add by zhouerlong prize launcher 20180906
            Drawable f=ThemeIconTool.getInstance().getThemeIcon(app.getComponentName(), getFullResIcon(app), mContext);
            
//add by zhouerlong prize launcher 20180906
			li.createBadgedIconBitmap(f, app.getUser(),
    ...
    protected CacheEntry cacheLocked(
        ...
        if (entry == null || (entry.isLowResIcon && !useLowResIcon)) {
            ...
            if (!getEntryFromDB(cacheKey, entry, useLowResIcon) || DEBUG_IGNORE_CACHE) {
                ...
                if (info != null) {
//add by zhouerlong prize launcher 20180906
                            Drawable f= ThemeIconTool.getInstance().getThemeIcon(componentName, getFullResIcon(info), mContext);
                    
//add by zhouerlong prize launcher 20180906
					LauncherIcons li = LauncherIcons.obtain(mContext);
//add by zhouerlong prize launcher 20180906
                    li.createBadgedIconBitmap(f, info.getUser(),
